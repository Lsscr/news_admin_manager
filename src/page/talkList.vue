  ...
  <div class="fillcontain">
    ...
    <div>
      <el-table :data="talkData">
        ...
        <el-table-column prop="userNick" label="用户"> </el-table-column>
        <el-table-column prop="userId" label="ID"> </el-table-column>
        <el-table-column prop="talk" label="内容"> </el-table-column>
        <el-table-column prop="sendTime" label="日期"> </el-table-column>
