  ...
  <div class="fillcontain">
    ...
    <div>
      <el-table :data="tableData">
        ...
        <el-table-column prop="password" label="用户密码" width="150"> </el-table-column>
        ...
        <el-table-column prop="lastLoginTime" label="最近登录日期"> </el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-switch
              @change="changeBanned(scope.row)"
              v-model="tableData[scope.$index].banned"
              active-value="1"
              inactive-value="0"
              active-text="禁言"
