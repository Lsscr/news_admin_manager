  ...
  <div class="fillcontain">
      ...
      <el-form :model="ruleForm" label-width="110px" class="demo-formData" style="margin-top: 10px">
        <el-form-item label="关键字" prop="title">
          <el-input v-model="keyWords" placeholder="请输入关键字" style="width: 600px" clearable>
            <el-select
              v-model="ruleForm.keySelect"
              slot="prepend"
              placeholder="ruleForm.keySelect"
              style="width: 130px"
            >
    ...
    <div class="table_container">
      <el-table :data="tableData" highlight-current-row>
        <el-table-column type="expand">
          <el-form slot-scope="props" label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="标签">
              <el-tag v-for="i in props.row.tags" :key="i" size="small" type="success" style="margin-right: 10px">{{
                JOKE_TAGS[i]
              }}</el-tag>
            </el-form-item>
            <el-form-item label="首页图片">
              <el-image
                @click="showImg(props.$index, props.row)"
                style="width: 120px; height: 120px; margin-top: 10px"
                class="avatar"
                v-if="props.row.coverImg"
        ...
        <el-table-column property="jokeUserNick" label="段子作者"> </el-table-column>
        <el-table-column property="postTime" label="发布时间" sortable> </el-table-column>
        <el-table-column property="jokeId" label="段子ID"> </el-table-column>
      ...
      <el-dialog title="预览" :visible.sync="dialogImgVisible" width="50%">
        <el-image
          style="width: 90%; height: auto; margin-top: 10px"
          class="avatar"
          v-if="selectTable.coverImg"
          :src="selectTable.coverImg"
        ></el-image>
      </el-dialog>
