  ...
  <div class="head-root">
    <div style="padding: 10px; min-height: 500px">
      ...
      <el-table :data="commentData" highlight-current-row>
        ...
        <el-table-column property="commentNick" label="昵称"> </el-table-column>
        <el-table-column property="commentUserId" label="ID"> </el-table-column>
        <el-table-column property="commentDate" label="评论时间"> </el-table-column>
        <el-table-column property="commentDetails" label="内容"> </el-table-column>
      </el-table>
    </div>
